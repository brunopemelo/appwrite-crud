...
async function deleteIntepretation(id: string) {
    try {
...
async function updateIntepretation(id: string, data: { term: string, intepretation: string }) {
    try {
...
export async function PUT(req: Request, { params }: { params: { id: string } }) {
    try {
        ...
        await updateIntepretation(id, interpretation)

        return NextResponse.json({ message: "Intepretation updated" })
    } catch (error) {
        return NextResponse.json(
